...
import { PlayTriangleIcon, TeenMutant, CoinIcon, TournamentIcon, SkinsIcon, UsersIcon, XIcon, ShareIcon } from '../components/icons';
...
export const Achievements: React.FC<PageProps> = ({ setActivePage, onBack }) => {
