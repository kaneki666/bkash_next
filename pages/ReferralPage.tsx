...
import { LeftArrowIcon, UsersIcon, ClipboardCopyIcon } from '../components/icons';

export const ReferralPage: React.FC<PageProps> = ({ setActivePage, onBack }) => {
    ...
    return (
        <div className="p-4 text-text-primary relative h-full flex flex-col">
            ...
            <div className="flex-grow flex flex-col items-center justify-center text-center">
                ...
                <h1 className="text-3xl font-extrabold text-primary mb-2">Refer & Earn</h1>
                <p className="text-text-secondary max-w-xs mb-8">
                    Invite your friends to join the Jungle Journey and you'll both receive <span className="font-bold text-text-primary">500 Coins</span> and <span className="font-bold text-text-primary">100 XP</span>!
                </p>

                <div className="w-full max-w-xs">
                    <p className="text-sm text-text-secondary mb-2">Your unique referral code:</p>
                    <div className="relative bg-primary-light border-2 border-dashed border-primary/40 rounded-lg p-4 flex items-center justify-center">
                        <span className="text-secondary-action-dark font-mono text-2xl tracking-widest">{referralCode}</span>
                    </div>
                    <button 
                        onClick={handleCopy}
